...
namespace ESFA.DC.Operations.Reports.Tests.Reports.ILRProvidersReturningFirstTimePerDayReport
{
    public class ILRProvidersReturningFirstTimePerDayReportModelBuilderTests
    {
        ...
        public void BuildModelTest()
        {
            ...
            providerServiceMock.Setup(x => x.GetILRProvidersReturningFirstTimePerDay(It.IsAny<int>(), It.IsAny<int>(), CancellationToken.None)).ReturnsAsync(BuildIlrReturns());
            ...
            result.IlrProvidersReturningFirstTimePerDaysList.Count.Should().Be(5);
        }

        private List<ILRProvidersReturningFirstTimePerDay> BuildIlrReturns()
        {
            return new List<ILRProvidersReturningFirstTimePerDay>
            {
